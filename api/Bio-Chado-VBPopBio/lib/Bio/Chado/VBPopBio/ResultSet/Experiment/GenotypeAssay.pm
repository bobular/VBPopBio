...
=head2 create_from_isatab
 ...
 Usage: $genotype_assays->create_from_isatab($assay_name, $assay_data, $project, $stock, $ontologies, $study, $isa_parser);
...
sub create_from_isatab {
  ...
  $genotype_assay->relink($saved_links) if ($saved_links);
